...
wandb.init(project="Gemma_7B_MalayaLLM", name = "Finetune")
...
model, tokenizer = FastLanguageModel.from_pretrained(
    model_name =  "Merged_Gemma_7B_MalayaLLM_Pretrain",
...
wandb.finish()
model.save_pretrained_merged("Merged_Gemma_7B_MalayaLLM_Finetune", tokenizer, save_method = "merged_16bit",)